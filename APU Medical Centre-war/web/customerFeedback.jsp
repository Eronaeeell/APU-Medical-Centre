        ...
        <table class="table table-sm table-hover">
            ...
            %>
                <tr>
                    ...
                    <td><%= fb.get("suggestions") != null ? fb.get("suggestions") : "-" %></td>
                    <td><span class="badge badge-pill <%= badgeClass %>"><%= status %></span></td>
                </tr>
            <% } } else { %>
                <tr>
                    <td colspan="7" class="text-center text-muted">No feedback history available</td>
                </tr>
            <% } %>
            </tbody>
        </table>
...
<div class="modal fade" id="feedbackModal">
    <div class="modal-dialog modal-lg">
        <form method="post" action="CustomerFeedbackServlet" class="modal-content">
            ...
            <div class="modal-body">
                ...
                <input type="hidden" id="modal-counter" name="counterStaff">
                ...
                <div class="form-group">
                    <label for="counterStaffFeedback">Counter Staff Feedback</label>
                    <textarea class="form-control" name="counterStaffFeedback" id="counterStaffFeedback" rows="3" required></textarea>
                </div>
...
<script>
    $('.feedback-btn').on('click', function () {
        ...
        $('#modal-counter').val($(this).data('counter'));
        $('#modal-type').val($(this).data('type'));
